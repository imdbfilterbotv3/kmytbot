...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('support', url='https://t.me/Rasputin98'),
                InlineKeyboardButton('channel', url='https://t.me/Rasputin98')
            ],
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/klmalayalimallu')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('movie club', url='https://t.me/klmalayalimallu')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/klmalayalimallu")]
        )
    else:
        btn.append(
